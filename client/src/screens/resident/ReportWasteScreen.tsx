...
const WASTE_TYPES: WasteRequest["type"][] = [
  "General",
  "Recyclables",
  "Hazardous",
  "Bulky",
...
export const RequestPickupScreen: React.FC = () => {
  ...
  return (
    <ScreenContainer scrollable>
        ...
        <View style={StyleSheet.absoluteFillObject}>
          ...
          >
            ...
            <AppText
              variant="body"
              color={theme.colors.surface}
              style={{ marginTop: 8, textAlign: "center", opacity: 0.9 }}
            >
      ...
      >
        ...
        >
          ...
          <TouchableOpacity
            style={[
              styles.chip,
              { margin: 0, height: 48, justifyContent: "center" },
              errors.scheduledDate && { borderColor: theme.colors.error },
            ]}
        ...
        >
          ...
          <TouchableOpacity
            style={[
              styles.chip,
              { margin: 0, height: 48, justifyContent: "center" },
              errors.scheduledTime && { borderColor: theme.colors.error },
            ]}
      ...
      <AppInput
        label="Penalty Fee You want to pay (₦)"
        value={amount}
