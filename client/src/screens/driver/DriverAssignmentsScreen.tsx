  ...
  const renderRoute = ({
    ...
    return (
      <TouchableOpacity
        activeOpacity={0.8}
        onPress={() =>
          navigation.navigate("AssignmentDetails", { routeId: item.id })
        }
      >
        <AppCard
          ...
          <View style={styles.metricsRow}>
            <View style={styles.metric}>
              ...
              <AppText variant="caption" style={styles.metricText}>
                {item.stops.filter((s) => s.status === "Completed").length}/
  ...
  return (
    <ScreenContainer>
      <Animatable.View animation="fadeInDown" delay={100} style={styles.header}>
        <AppText variant="h2">My Tasks</AppText>
      </Animatable.View>
